...
public class LoginRegistServer {
    private ORB orb;
    private POA rootPOA;
    ...
    public static void main(String[] args) {
        LoginRegistServer loginRegistServer = new LoginRegistServer();
        loginRegistServer.init();
    }
    ...
    private void init() {
        try {
            ...
            creatorImpl.setLoginRegistServer(this);
            ...
            System.out.println("server.LoginRegistServer is ready and waiting....");
