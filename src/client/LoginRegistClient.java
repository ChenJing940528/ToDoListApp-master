...
public class LoginRegistClient {
    ...
    public LoginRegistClient() {
        reader = new BufferedReader(new InputStreamReader(System.in));
    }

    public static void main(String[] args) {
        LoginRegistClient loginRegistClient = new LoginRegistClient();
        loginRegistClient.init();
        loginRegistClient.procedure();
    }
    ...
    public void procedure() {
        ...
        try {
            while (true) {
                System.out.println("Welcome to Login_Regist_System!Please choose:");
